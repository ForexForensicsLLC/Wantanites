...
#include <WantaCapital/EAs/Active/TinyMBGapBreak/MBBreak/TinyMBGapBreak.mqh>
...
int OnInit()
{
    ...
    TMBBuys = new TinyMBGapBreak(MagicNumbers::DowTinyMBGapBreakMBBreakBuys, OP_BUY, MaxCurrentSetupTradesAtOnce, MaxTradesPerDay, StopLossPaddingPips, MaxSpreadPips,
    ...
    TMBSells = new TinyMBGapBreak(MagicNumbers::DowTinyMBGapBreakMBBreakSells, OP_SELL, MaxCurrentSetupTradesAtOnce, MaxTradesPerDay, StopLossPaddingPips, MaxSpreadPips,
                                  RiskPercent, EntryWriter, ExitWriter, ErrorWriter, SetupMBT);
