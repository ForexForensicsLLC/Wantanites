...
void FirstMB::InvalidateSetup(bool deletePendingOrder, int error = Errors::NO_ERROR)
{
...
bool FirstMB::Confirmation()
{
    ...
    bool dojiInZone = EAHelper::DojiInsideMostRecentMBsHoldingZone<FirstMB>(this, mSetupMBT, mFirstMBInSetupNumber);
