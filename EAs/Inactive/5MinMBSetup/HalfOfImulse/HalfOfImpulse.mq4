...
#include <SummitCapital/EAs/Inactive/5minMBSetup/HalfOfImulse/HalfOfImpulse.mqh>
...
string EAName = "Nas/";
string SetupTypeName = "HalfOfImpulse/";
...
HalfOfImpulse *TDIZBuys;
HalfOfImpulse *TDIZSells;
...
int OnInit()
{
    ...
    TDIZBuys = new HalfOfImpulse(-1, OP_BUY, MaxCurrentSetupTradesAtOnce, MaxTradesPerDay, StopLossPaddingPips, MaxSpreadPips, RiskPercent, EntryWriter,
    ...
    TDIZBuys.AddTradingSession(16, 30, 18, 0);

    TDIZSells = new HalfOfImpulse(-2, OP_SELL, MaxCurrentSetupTradesAtOnce, MaxTradesPerDay, StopLossPaddingPips, MaxSpreadPips, RiskPercent, EntryWriter,
                                  ExitWriter, ErrorWriter, SetupMBT);
    ...
    TDIZSells.AddTradingSession(16, 30, 18, 0);
