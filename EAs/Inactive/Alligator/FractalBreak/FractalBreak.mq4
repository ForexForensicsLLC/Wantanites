...
string EAName = "Dow/";
string SetupTypeName = "FractalBreak/";
...
MBTracker *SetupMBT;
FractalBreak *NasiaBuys;
FractalBreak *NasiaSells;
...
int OnInit()
{
    ...
    NasiaBuys = new FractalBreak(-1, OP_BUY, MaxCurrentSetupTradesAtOnce, MaxTradesPerDay, StopLossPaddingPips, MaxSpreadPips, RiskPercent, EntryWriter, ExitWriter,
    ...
    NasiaSells = new FractalBreak(-1, OP_SELL, MaxCurrentSetupTradesAtOnce, MaxTradesPerDay, StopLossPaddingPips, MaxSpreadPips, RiskPercent, EntryWriter, ExitWriter,
                                  ErrorWriter, SetupMBT);
