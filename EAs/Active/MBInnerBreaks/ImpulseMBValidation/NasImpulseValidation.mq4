...
#include <SummitCapital/EAs/Active/MBInnerBreaks/ImpulseMBValidation/ImpulseValidation.mqh>
...
string EAName = "Nas/";
string SetupTypeName = "ImpulseValidation/";
...
double MinMBValidationPercentChange = 0.9;
...
int OnInit()
{
    ...
    MBInnerBreakBuys.mMinMBValidationPercentChange = MinMBValidationPercentChange;
    ...
    MBInnerBreakSells.mMinMBValidationPercentChange = MinMBValidationPercentChange;
