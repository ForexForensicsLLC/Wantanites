...
#include <SummitCapital/EAs/Active/ImpulseReversal/InnerBreakBigDipper/InnerBreakBigDipper.mqh>
...
string EAName = "Dow/";
string SetupTypeName = "InnerBreakBigDipper/";
...
// Dow
double MinPercentChange = 0.8;
double LargeBodyPips = 15;
double MaxBigDipperPips = 25;
...
int OnInit()
{
    ...
    IRBuys = new ImpulseReversal(MagicNumbers::DowImpulseReversalInnerBreakBigDipperBuys, OP_BUY, MaxCurrentSetupTradesAtOnce, MaxTradesPerDay, StopLossPaddingPips, MaxSpreadPips, RiskPercent,
    ...
    IRBuys.mLargeBodyPips = LargeBodyPips;
    IRBuys.mMaxBigDipperPips = MaxBigDipperPips;
    ...
    IRSells = new ImpulseReversal(MagicNumbers::DowImpulseReversalInnerBreakBigDipperSells, OP_SELL, MaxCurrentSetupTradesAtOnce, MaxTradesPerDay, StopLossPaddingPips, MaxSpreadPips, RiskPercent,
                                  EntryWriter, ExitWriter, ErrorWriter, SetupMBT);
    IRSells.SetPartialCSVRecordWriter(PartialWriter);
    IRSells.AddPartial(CloseRR, 100);

    IRSells.mMinPercentChange = MinPercentChange;
    IRSells.mLargeBodyPips = LargeBodyPips;
    IRSells.mMaxBigDipperPips = MaxBigDipperPips;
