...
#include <SummitCapital/EAs/Inactive/ImpulseContinuation/TinyMBBreak/TinyMBBreak.mqh>
...
double MaxMBHeight = 700;
double MinGapPips = 400; //
double MaxEntrySlippagePips = 300;
