...
TheSunriseShatterSingleMBC *TSSSMB;
TheSunriseShatterDoubleMBC *TSSDMB;
TheSunriseShatterLiquidationMBC *TSSLMB;
...
int OnInit()
{
    ...
    TSSSMB = new TheSunriseShatterSingleMBC(MaxTradesPerStrategy, StopLossPaddingPips, MaxSpreadPips, RiskPercent, MRFTS, MBT);
    TSSDMB = new TheSunriseShatterDoubleMBC(MaxTradesPerStrategy, StopLossPaddingPips, MaxSpreadPips, RiskPercent, MRFTS, MBT);
    TSSLMB = new TheSunriseShatterLiquidationMBC(MaxTradesPerStrategy, StopLossPaddingPips, MaxSpreadPips, RiskPercent, MRFTS, MBT);
